# Blenderの道しるべ - Windowsタスクスケジューラへの週次チェック登録スクリプト
...
Register-ScheduledTask -TaskName $taskName -Trigger $trigger -Action $action -Settings $settings -Description "Blenderの道しるべ 週次リンクチェック" -RunLevel Highest
